              ...
              {[
                {
                  ...
                  description: "AI extracts clauses & risks",
                  example: "Kira Systems",
                  solution: "NLP contract analysis"
                },
                {
                  useCase: "Legal Research Automation",
                  description: "Summaries & case retrieval",
                  example: "Lexis+ AI",
                  solution: "Gen‑AI research assistant"
                },
                {
                  useCase: "E‑Discovery",
                  description: "Identify relevant documents",
                  example: "Relativity",
                  solution: "AI document classification"
                },
                {
                  useCase: "Compliance Monitoring",
                  description: "Track regulatory changes",
                  example: "BigLaw firms",
                  solution: "AI regulatory intelligence"
                },
                {
                  useCase: "Document Drafting",
                  description: "AI‑assisted drafting",
                  example: "Harvey AI",
                  solution: "Gen‑AI drafting engine"
                }
              ].map((row, index) => (
                <div
                  key={index}
