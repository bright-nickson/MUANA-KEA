        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              {[
                {
                  useCase: "Predictive Equipment Maintenance",
                  description: "Detect failures in heavy machinery",
                  example: "Rio Tinto",
                  solution: "IoT + ML maintenance"
                },
                {
                  useCase: "Ore Grade Prediction",
                  description: "Optimize extraction quality",
                  example: "BHP",
                  solution: "ML geological modelling"
                },
                {
                  useCase: "Autonomous Haulage",
                  description: "Self‑driving mining trucks",
                  example: "Komatsu AHS",
                  solution: "AI‑driven fleet automation"
                },
                {
                  useCase: "Safety Monitoring",
                  description: "Detect hazards in real time",
                  example: "Anglo American",
                  solution: "CV + sensor fusion"
                },
                {
                  useCase: "Energy Optimization",
                  description: "Reduce fuel & power usage",
                  example: "Vale",
                  solution: "AI energy‑efficiency models"
                }
              ].map((row, index) => (
                <div
                  key={index}
