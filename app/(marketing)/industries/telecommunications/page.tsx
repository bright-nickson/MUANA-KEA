        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              {[
                {
                  useCase: "Network Optimization",
                  description: "Predict congestion & outages",
                  example: "Vodafone",
                  solution: "AI network orchestration"
                },
                {
                  useCase: "Customer Service Automation",
                  description: "AI chatbots for support",
                  example: "MTN",
                  solution: "Gen‑AI customer assistant"
                },
                {
                  useCase: "Churn Prediction",
                  description: "Identify customers likely to leave",
                  example: "Airtel",
                  solution: "ML churn models"
                },
                {
                  useCase: "Fraud Detection",
                  description: "SIM fraud, subscription fraud",
                  example: "Orange",
                  solution: "Real‑time anomaly detection"
                },
                {
                  useCase: "Predictive Maintenance",
                  description: "Tower & fiber monitoring",
                  example: "AT&T",
                  solution: "IoT + ML fault prediction"
                }
              ].map((row, index) => (
                <div
                  key={index}
