              ...
              {[
                {
                  ...
                  description: "Detect machine failures",
                  example: "Siemens",
                  solution: "IoT + ML"
                },
                {
                  useCase: "Quality Inspection",
                  description: "Detect defects via vision",
                  example: "BMW",
                  solution: "Computer vision QA"
                },
                {
                  useCase: "Supply Chain Optimization",
                  description: "Predict disruptions",
                  example: "Toyota",
                  solution: "ML forecasting"
                },
                {
                  useCase: "Digital Twins",
                  description: "Simulate factory operations",
                  example: "GE",
                  solution: "Real‑time simulation"
                },
                {
                  useCase: "Robotics Automation",
                  description: "AI‑driven robots",
                  example: "Tesla",
                  solution: "Autonomous robotic workflows"
                }
              ].map((row, index) => (
                <div
                  key={index}
